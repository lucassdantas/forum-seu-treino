...
export const Lightbox: React.FC<LightboxProps> = ({ imageUrl }) => {
  ...
  return (
    <>
      <img src={imageUrl} onClick={openLightbox} className="cursor-pointer max-h-[250px] object-cover w-full rounded" />
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-start justify-center z-50 w-full" onClick={closeLightbox}>
          <div className="flex justify-center items-center w-[80%] h-[80%] overflow-scroll ">
